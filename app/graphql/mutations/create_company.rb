class Mutations::CreateCompany < GraphQL::Schema::Mutation
  ...
  def resolve(name: nil)
    ...
    if context[:controller].user_signed_in?
      ...
      user_role = RolesUser.create(user_id: context[:controller].current_user.id, role_id: owner_id, company_id: company.id)
      ...
      user_company = UsersCompany.create(user_id: context[:controller].current_user.id, company_id: company.id)
