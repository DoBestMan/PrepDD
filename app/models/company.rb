class Company < ApplicationRecord
  # Broker Companies
  has_many :child_broker,
           class_name: 'BrokerCompany', foreign_key: 'parent_broker_id'
  has_many :broker_children, through: :child_broker, source: :child_broker

  has_many :parent_broker,
           class_name: 'BrokerCompany', foreign_key: 'child_broker_id'
  has_many :broker_parents, through: :parent_broker, source: :parent_broker

  # Parent Companies
  has_many :company_child,
           class_name: 'ParentCompany', foreign_key: 'parent_company_id'
  has_many :company_chidlren, through: :company_child, source: :child_company

  has_many :company_parent,
           class_name: 'ParentCompany', foreign_key: 'child_company_id'
